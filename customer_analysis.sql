...
--Q2)Which customers used a discount but still spent more than the average am

select customer_id,purchase_amount
from customer
where discount_id='Yes' and purchase_amount >= ( select avg(purchase_amount) from customer)
...
order by avg(review_ratind) desc
limit 5

--Q4. Compare the average Purchase Amounts between Standard and Express Shipping. 
select shipping_type, ROUND(avg(purchase_amount),2)
from customer
where shipping_typr in ('Standard' , 'Express')
